...
export const ALERTAS_CONFIG = {
  ...
  STYLES: {
    ...
    FILTER_TITLE: 'text-sm font-bold text-amber-700 font-mono tracking-wider mb-3',
    FILTER_LABEL: 'block text-xs font-bold text-amber-700 font-mono tracking-wider mb-1',
    FILTER_SELECT: 'w-full bg-neutral-800 text-white border border-neutral-600 rounded px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-amber-800 focus:border-amber-800',
