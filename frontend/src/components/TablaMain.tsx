/**
 * TablaMain - Componente principal para administración de tablas del sistema
...
const TablaMain = forwardRef<TablaMainRef, TablaMainProps>(({
...
TablaMain.displayName = 'TablaMain';
