        ...
        {selectedLotes.length > 0 && (
          <div className="mb-4 flex justify-end">
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-mono text-sm transition-colors flex items-center gap-2"
            >
                      ...
                      >
                        ...
                        >
                          <input
                            ...
                            className="w-4 h-4 text-blue-500 border-gray-300 rounded focus:ring-blue-600 cursor-pointer"
                          />
                        </td>
