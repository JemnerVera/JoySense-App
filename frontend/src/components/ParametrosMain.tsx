/**
 * ParametrosMain - Componente principal para administración de parámetros del sistema
...
export interface ParametrosMainRef {
...
const ParametrosMain = forwardRef<ParametrosMainRef, ParametrosMainProps>(({
...
ParametrosMain.displayName = 'ParametrosMain';

export default ParametrosMain;
