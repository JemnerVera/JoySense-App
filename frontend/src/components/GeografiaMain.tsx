/**
 * GeografiaMain - Componente principal para administración de tablas geográficas
...
export interface GeografiaMainRef {
...
const GeografiaMain = forwardRef<GeografiaMainRef, GeografiaMainProps>(({
...
GeografiaMain.displayName = 'GeografiaMain';

export default GeografiaMain;
