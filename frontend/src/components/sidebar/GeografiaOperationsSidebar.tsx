...
interface GeografiaOperationsSidebarProps {
  isExpanded: boolean;
  onMouseEnter: () => void;
  onMouseLeave: () => void;
...
const GeografiaOperationsSidebar: React.FC<GeografiaOperationsSidebarProps> = ({
  isExpanded,
  onMouseEnter,
  onMouseLeave,
  selectedTable,
...
export default GeografiaOperationsSidebar;
