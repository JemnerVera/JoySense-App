/**
 * ConfiguracionOperationsSidebar - Sidebar Auxiliar para CONFIGURACIÓN
 * Muestra ESTADO, CREAR, ACTUALIZAR, MASIVO para la tabla seleccionada
 */
...
interface ConfiguracionOperationsSidebarProps {
  isExpanded: boolean;
  onMouseEnter: () => void;
  onMouseLeave: () => void;
...
const ConfiguracionOperationsSidebar: React.FC<ConfiguracionOperationsSidebarProps> = ({
  isExpanded,
  onMouseEnter,
  onMouseLeave,
  selectedTable,
...
export default ConfiguracionOperationsSidebar;
