/**
 * AgrupacionOperationsSidebar - Sidebar Auxiliar 2 para AGRUPACIÓN
...
interface AgrupacionOperationsSidebarProps {
  isExpanded: boolean;
  onMouseEnter: () => void;
  onMouseLeave: () => void;
...
const AgrupacionOperationsSidebar: React.FC<AgrupacionOperationsSidebarProps> = ({
  isExpanded,
  onMouseEnter,
  onMouseLeave,
  selectedTable,
...
export default AgrupacionOperationsSidebar;
