...
interface AccesoOperationsSidebarProps {
  isExpanded: boolean;
  onMouseEnter: () => void;
  onMouseLeave: () => void;
...
const AccesoOperationsSidebar: React.FC<AccesoOperationsSidebarProps> = ({
  isExpanded,
  onMouseEnter,
  onMouseLeave,
  activeSubTab,
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    onTabChange?.(`acceso-permiso-${operation.id}`);
                  }}
...
export default AccesoOperationsSidebar;
