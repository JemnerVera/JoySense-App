...
export const filterColumnsByTable = (
  ...
  const tableColumnMaps: Record<string, string[]> = {
    ...
    'permiso': ['perfilid', 'origenid', 'fuenteid', 'objetoid', 'puede_ver', 'puede_insertar', 'puede_actualizar', 'puede_eliminar', 'statusid', 'usercreatedid', 'datecreated', 'usermodifiedid', 'datemodified'],
